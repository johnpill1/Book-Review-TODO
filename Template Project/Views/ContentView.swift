...
struct ContentView: View {
    ...
    // TODO: Query the 'database' using a different sort parameter such as alphabetically by author.
    ...
    var body: some View {
        ...
        NavigationStack {
            VStack {
                ...
                List {
                    ForEach(books) { book in                                        // This loops through the books array.
                        NavigationLink(destination: DetailView(book: book)) {       // This creates the link to the DetailView page.
            ...
            .navigationTitle("TODO - Change me use 🌍!")
            ...
            .overlay(
                Button {
                    ...
                    // TODO: Change the addBookReview button icon.
    ...
    func emptyFields() {
        ...
        // TODO: Empty all the fields to their default state ("". 1.0, false etc).
        // Do - rating, review, favorite, finishedReading as well.
